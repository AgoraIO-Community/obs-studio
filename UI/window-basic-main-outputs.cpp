...
//		agoraEncodedDataOutput = obs_output_create("agora_encoded_output_info",
//		                                "simple_agora_encoded_output_info", nullptr, nullptr);
//		if (!agoraEncodedDataOutput) {
//		    throw "Failed to create recording output "
//		    "(agora encoded output)";
//		}
//		obs_output_release(agoraEncodedDataOutput);
...
//	obs_output_set_video_encoder(agoraEncodedDataOutput, h264Recording);
//	obs_output_set_audio_encoder(agoraEncodedDataOutput, aacRecording, 0);
